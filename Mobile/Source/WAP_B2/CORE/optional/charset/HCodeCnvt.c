...
KSC2Unicode_calcLen(BYTE *str, BOOL isNullTerminated, UINT32 readBytes, UINT32 *strByteLen)
{
	...
	else
	{
		...
		*strByteLen = readBytes;
		...
		//CLNTa_log(1,0,"KSC2Unicode_calcLen] str[%s]",str);

		if (str)
		{
			//CLNTa_log(1,0,"KSC2Unicode_calcLen] str is not null");
	...
	//CLNTa_log(1,0,"KSC2Unicode_calcLen] iLen[%d] ",iLen);
	return iLen;
}
