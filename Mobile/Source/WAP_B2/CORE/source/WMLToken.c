...
const WCHAR * const ppchTagTokens[STAT_NBROFTAGS]=
{
	WMLTag1,
	WMLTag2,
	WMLTag3,
...
const BYTE pbTagBytes[STAT_NBROFTAGS]=
{
	'\x1C',
	'\x23',
	'\x22',
...
const WCHAR * const ppchAttrTokens[STAT_NBROFATTR]=
{
	WMLAttr1,
	WMLAttr2,
	WMLAttr3,
...
const BYTE pbAttrBytes[STAT_NBROFATTR]=
{
	'\x05',
	'\x52',
	'\x0C',
...
const WCHAR * const ppwchGSMEvents[STAT_NBROFGSMEVENTS]=
{
	GSMEvent1,
	GSMEvent2,
	GSMEvent3,
...
const BYTE pbGSMEventBytes[STAT_NBROFGSMEVENTS]=
{
	WTAEvent_gsm_ca,
	WTAEvent_gsm_ch,
	WTAEvent_gsm_ru
...
const WCHAR * const ppwchWTAEvents[STAT_NBROFIS136EVENTS]=
{
	IS136Event1,
	IS136Event2
};

const BYTE pbWTAEventBytes[STAT_NBROFIS136EVENTS]=
{
	WTAEvent_is136_ia,
	WTAEvent_is136_if
};
