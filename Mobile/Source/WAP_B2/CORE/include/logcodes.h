...
enum logCodes
{
    ...
    ***************************************************************************/
    ...
    log_wtls_CRYPTa_getCipherMethods,
    log_wtls_CRYPTa_encrypt,
    log_wtls_CRYPTa_encryptInit,
    log_wtls_CRYPTa_encryptUpdate,
    log_wtls_CRYPTa_encryptFinal,
    log_wtls_CRYPTa_decrypt,
    log_wtls_CRYPTa_hash,
    log_wtls_CRYPTa_hashInit,
    log_wtls_CRYPTa_hashUpdate,
    log_wtls_CRYPTa_hashFinal,
    log_wtls_CRYPTa_getClientKeyExchangeIds,
    log_wtls_CRYPTa_keyTransportRSA,
    log_wtls_CRYPTa_keyAgreementDH,
    log_wtls_CRYPTa_keyAgreementECDH,
    log_wtls_CRYPTa_secretKeyAgreement,
    log_wtls_CRYPTa_nullKeyAgreement,
    log_wtls_CRYPTa_deriveMasterSecret,
    log_wtls_CRYPTa_PRF,
    log_wtls_CRYPTa_getTrustedKeyExchangeIds,
