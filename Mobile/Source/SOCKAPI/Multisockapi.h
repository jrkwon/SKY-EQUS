...
#define	MAX_TCP_SOCKS	1
#define	MAX_UDP_SOCKS	MAX_SOCKS	//	MAX_SOCKS defined in dssocki.h
extern	sint15	g_nAppID[MAX_APPS];	//	MAX_APPS defined in dssocki.h
extern	sint15	g_nTCPSockID[MAX_TCP_SOCKS], g_nUDPSockID[MAX_UDP_SOCKS];

extern	sint15	sockApi_SaveApp
(
	sint15	appID
);

extern	sint15	sockApi_SaveSocket
(
	sint15	socketID
);

extern	sint15	sockApi_DeleteApp
(
	sint15	appID
);

extern	sint15	sockApi_DeleteTCPSocket
(
	sint15	socketID
);

extern	sint15	sockApi_DeleteUDPSocket
(
	sint15	socketID
);
