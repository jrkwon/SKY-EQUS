...
$Header:   L:/src/asw/COMMON/vcs/smsi.h_v   1.1   19 Oct 2000 12:55:50   hqu  $
...
typedef enum
{
  ...
  ////////////////////////////////////////////////////////////////
  SMSI_SHINSEGI_MYBELL,
  SMSI_SHINSEGI_MYBELL2,
  SMSI_SHINSEGI_WAP_PUSH,
  SMSI_MYBELL,	 // MyBell = 64000
  SMSI_MYBELL2,
  SMSI_MYBELL3,
  SMSI_WAP_MAIL, // 65490,
  SMSI_WAP_PUSH  // 65491
#ifdef FEATURE_SKVM
  ,SMSI_SKVM_LOAD // 64100d
  ,SMSI_SKVM_DATA // 64101
#endif
/* reo 2001.03.15 {-- */
