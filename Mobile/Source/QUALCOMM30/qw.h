...
$Header:   L:/src/asw/MSM5000/VCS/qw.h_v   1.3   30 Oct 2000 11:58:00   ldefauw  $
...
#define QW_CVT_Q2N(qw) (*( (unsigned long long *)(qw) ))
#else
#define QW_CVT_Q2N(qw) (*( (uint64 *)(qw) ))
#endif //	_FOR_BROWSER						// by chos for browser

/*===========================================================================

INLINE FUNCTION QW_CVT_N2Q - Convert a  "native 64-bit type (uint64)" to a 
  'qword'.
...
===========================================================================*/
INLINE unsigned long * QW_CVT_N2Q(uint64 *p_n64) { return ((unsigned long *)(p_n64)); }
