...
$Header:   O:/src/asw/COMMON/vcs/fsi.h_v   1.1   02 Apr 2001 16:15:22   davidb  $
...
// chojw 00.08.28 - 다른 곳에서 선언된 KICK_WATCHDOG Macro 때문에 redefine error가
// 발생하는 것을 방지하기 위하여 undef 를 하였음.
// 이 KICK_WATCHDOG을 사용하는 경우 FS Task에서 사용됨을 확인하기 바람
#undef KICK_WATCHDOG
...
// chojw 00.08.28 - 다른 곳에서 선언된 마크로를 무효화하기 위하여 undef 하였음.
#undef ABS
...
/* Number of erased blocks to maintain beyond one sector's worth */
#define  FS_GC_CLEAN_RSVD       6

/* Number of blocks reserved only for transaction log files */
