...
/*===========================================================================
  ...
  $Header:   L:/src/asw/COMMON/vcs/sdevmenu.h_v   1.1   15 Nov 2000 10:20:44   dpendlet  $
...
FUNCTION SDM_UI_GET_TABLE_DEV_MAP                      EXTERNALIZED FUNCTION

DESCRIPTION
  Returns the DEV MAP selection menu. If NV contains a valid port mapping
  and it is in our list of port map choices, we indicate that as the
  current port map - UI will mark this with a "checkmark".
...
sdm_ui_map_menu_type * sdm_ui_get_table_dev_map
( 
  nv_stat_enum_type nv_result_stat,
  nv_item_type     *nv_data_buf      /* only valid if 
                                      * nv_result_stat == NV_DONE_S
...
FUNCTION SDM_UI_SET_DEV_MAP                           EXTERNALIZED FUNCTION
