...
/*--------------------------------------------------------------------------------
   Max Power Calibraion시 10db에 대한 Limit 값. 
   즉 Max Power Calibration시 1db를 변화시키려면 (RF_CDMA_MAXPOWER_SCALE / 10)
   의 값만큼 보정값을 조정한다.
---------------------------------------------------------------------------------*/
...
DESCRIPTION
  저온, 고온 조정시 Target Max Power와 현재 Max Power와의 차이를 계산하여
  보정치를 산출함
