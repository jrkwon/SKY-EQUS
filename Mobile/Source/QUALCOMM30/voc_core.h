...
/*===========================================================================
  ...
  $Header:   L:/src/asw/MSM5000/VCS/voc_core.h_v   1.3   15 Aug 2000 15:09:02   rmarkey  $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
08/11/00    sm     Updated FEATURE_AUDIO_AGC
                   Added VC_EVRC_RESET_REG and value definitions.
11/30/99    sm     Changed mdr's RX offset for new rx alignment.
07/21/99    sm     Fixed static gain parameters.  Added adaptive gain setting.
06/30/99  sm/RPW   Integrated AGC feature with VR/VM features. Added 
                   FEATURE_MINIMIZE_ISR_LOADING; added VC_PAD_ENC_PCM_COMPANDED
                   and VC_TX_PCM_MU_LAW_PAD (st), more misc values.
...
/* Base I/O address for Vocoder
*/
#if !defined (T_MSM3)
#define VC_BASE_IO               P_PCS4_IO
#endif /* !T_MSM3 */
...
#if !defined (T_MSM3)
#define VC_IO( inx )             (VC_BASE_IO + (inx))
#endif /* !T_MSM3 */
...
#else
#define VC_INX( io )             ((io) - VC_BASE_IO)
#endif /* T_MSM3 */
...
#if !defined (T_MSM3)
/* 80186-based MSM: make VC_RESET register definition here.  
 */
#define VC_RESET                       VC_IO( 0x00 )
#define VC_RESET_BOOT_DSP              1
#define VC_RESET_DOWNLOAD_QDSP1P       0
#endif /* !T_MSM3 */
...
#if !defined (T_MSM3)
/* 8-bit download interface. */
#define VC_FAST_LOAD_RAM_ADDR          VC_IO( 0xC4 )      
#define VC_FAST_LOAD_RAM_DATA          VC_IO( 0xC6 )
#else 
...
*/
#if !defined (T_MSM3)
#define VC_ENC_FRAME_ADVANCE           VC_IO( 0x02 )
#define VC_DEC_FRAME_ADVANCE           VC_IO( 0x06 )
#endif /* !T_MSM3 */
...
*/
#define VC_RX_OFFSET_NEW_TIMELINE_MDR      0x0  /*     0 ms from end*/
...
/* Decoder Interrupt Advance:  the vocoder will acquire frame timing on the
** first VOC_FRAME_REF after a write to ENC_FRAME_ADVANCE.  DEC_FRAME_ADVANCE
** and DEC_INT_ADVANCE registers must be written before writing the
** ENC_FRAME_ADVANCE register.  The Decoder interrupt, DEC_INT will occur
** DEC_INT_ADVANCE * 0.125ms after the Decoder frame boundary.
*/
#if !defined (T_MSM3)
#define VC_DEC_INT_ADVANCE       VC_IO( 0x0A )
#endif /* !T_MSM3 */
...
*/
#if !defined (T_MSM3)
#define VC_TX_PCM_CONTROL        VC_IO( 0x0C )
#endif /* !T_MSM3 */
...
#define VC_TX_PCM_MU_LAW_PAD_V   0x40    /* mu-law with padding            */
...
*/
#if !defined (T_MSM3)
#define VC_RX_PCM_CONTROL        VC_IO( 0x0E )
#endif /* !T_MSM3 */
...
/* TX PCM Write Data Register: The data to be transferred to the encoder
**                             when VOC_ENC_PCM_WR_EN is set.
*/
#if !defined (T_MSM3)
#define VC_ENC_PCM_WR_MSB        VC_IO( 0x10 )
#define VC_ENC_PCM_WR_LSB        VC_IO( 0x12 )
#endif /* !T_MSM3 */

/* RX PCM Write Data Register:  Initialize CODEC data through these registers.
*/
#if !defined (T_MSM3)
#define VC_DEC_PCM_WR_MSB        VC_IO( 0x14 )
#define VC_DEC_PCM_WR_LSB        VC_IO( 0x16 )
#endif /* !T_MSM3 */
...
*/
#if !defined (T_MSM3)
#define VC_TEST_CONTROL_1        VC_IO( 0x18 )
#endif /* !T_MSM3 */
...
*/
#if !defined (T_MSM3)
#define VC_TEST_CONTROL_2        VC_IO( 0x1A )
#endif /* !T_MSM3 */
...
*/
#if !defined (T_MSM3)
#define VC_MODE_CONTROL          VC_IO( 0x1E )
#endif /* !T_MSM3 */
...
*/
#if !defined (T_MSM3)
#define VC_VOX_CONTROL           VC_IO( 0x20 )
#endif /* !T_MSM3 */
...
#define VC_VOX_B0_CK_V      ( VC_ESEC_ENABLE_ENA_V  | VC_ESEC_NO_OUT_DIS_V \
  ...
  /* Note:  ESEC is disabled in carkit mode.  The result is discarded 
  ** eventhough the ESEC algorithm is enabled.
  */
...
*/
#if !defined (T_MSM3)
#define VC_PEEK_POKE_CONTROL     VC_IO( 0x22 )
#endif /* !T_MSM3 */
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
/* Encoder Sample Counter: MSM 2.3
*/
#if !defined (T_MSM3)
#define VC_ENC_SAMP_CNT          VC_IO( 0x22 )
#endif /* !T_MSM3 */
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/

/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
/* Peek/Poke address LSB
*/
#if !defined (T_MSM3)
#define VC_POKE_ADDR_LSB         VC_IO( 0x24 )
#endif /* !T_MSM3 */
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/

/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
/* Decoder Sample Counter: MSM 2.3
*/
#if !defined (T_MSM3)
#define VC_DEC_SAMP_CNT          VC_IO( 0x24 )
#endif /* !T_MSM3 */
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
...
*/
#if !defined (T_MSM3)
#define VC_POKE_DATA_MSB         VC_IO( 0x26 )
#endif /* !T_MSM3 */

/* Peek/Poke data LSB
*/
#if !defined (T_MSM3)
#define VC_POKE_DATA_LSB         VC_IO( 0x28 )
#endif /* !T_MSM3 */
...
*/
#if !defined (T_MSM3)
#define VC_ENC_RATE_CONTROL      VC_IO( 0x2A )
#endif /* !T_MSM3 */
...
/* Encoder Rate Limit Factor:  S value used in rate limiting.  Selecting
** between S and 1/S rate limiting is done in VC_ENC_RATE_CONTROL.
*/
#if !defined (T_MSM3)
#define VC_ENC_RATE_LIMIT_FACTOR VC_IO( 0x2C )
#endif /* !T_MSM3 */
...
*/
#if !defined (T_MSM3)
#define VC_FM_AUDIO_CONFIG       VC_IO( 0x2E )
#endif /* !T_MSM3 */
...
#define VC_FM_AUDIO_CONFIG_RES_M 0x51    /* Mask for reserved values       */
#define VC_FM_AUDIO_CONFIG_RES_V 0x00    /* Reserved values                */

/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/

/* VOX Control Parameter: Pre-qdsp1+ (MSM2310) only. */
#if !defined (T_MSM3)
#define VC_ENERGY_DECAY_MSB      VC_IO( 0x2E )
#define VC_ENERGY_DECAY_LSB      VC_IO( 0x30 )
#endif /* !T_MSM3 */
...
*/
#if !defined (T_MSM3)
#define VC_FM_TEST_CONTROL       VC_IO( 0x30 )
#endif /* !T_MSM3 */
...
#define VC_FM_INT_TEST_M         0x40    /* DFM Interface test mask        */
#define VC_FM_INT_TEST_ENA_V     0x40    /* Enable DEC-ENC loopback        */
#define VC_FM_INT_TEST_DIS_V     0x00    /* Disable DEC-ENC loopback       */
...
#define VC_FM_DEEMPH_M           0x04    /* FM De-emphasis                 */
#define VC_FM_DEEMPH_ENA_V       0x00    /* Enable FM de-emphasis          */
#define VC_FM_DEEMPH_DIS_V       0x04    /* Disable FM de-emphasis         */
...
#define VC_SAT_ECC_RES_M         0xF0    /* Mask for reserved values       */
#define VC_SAT_ECC_RES_V         0x00    /* reserved values                */

/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/

#if !defined (T_MSM3)
#define VC_BG_NOISE_DECAY_MSB    VC_IO( 0x32 )
#define VC_BG_NOISE_DECAY_LSB    VC_IO( 0x34 )
#endif /* !T_MSM3 */
...
*/
#if !defined (T_MSM3)
#define VC_SAT_LEVEL             VC_IO( 0x34 )
#endif /* !T_MSM3 */
...
*/
#if !defined (T_MSM3)
#define VC_SAT_THRESHOLD         VC_IO( 0x36 )
#endif /* !T_MSM3 */
...
/* VOX Control Parameter: Pre-qdsp1+ (MSM2310) only. */
#if !defined (T_MSM3)
#define VC_DEC_VOX_THRESH_MSB    VC_IO( 0x36 )
#define VC_DEC_VOX_THRESH_LSB    VC_IO( 0x38 )
#endif /* !T_MSM3 */
...
*/
#if !defined (T_MSM3)
#define VC_NS_CONTROL            VC_IO( 0x36 )
#endif /* !T_MSM3 */
...
*/
#if !defined (T_MSM3)
#define VC_TX_DEVIATION_LIMIT    VC_IO( 0x38 )
#endif /* !T_MSM3 */
...
*/
#if !defined (T_MSM3)
#define VC_FM_TX_GAIN            VC_IO( 0x3A )
#endif /* !T_MSM3 */
...
#if !defined (T_MSM3)
#define VC_ENC_WEIGHTING_MSB     VC_IO( 0x3A )
#define VC_ENC_WEIGHTING_LSB     VC_IO( 0x3C )
#endif /* !T_MSM3 */

/* The EVRC RESET register is used by the ARM when the decoder encounters
** a full to 1/8th rate transition in EVRC.  The ARM must set this register
** when a full to 1/8th rate transition is encountered, and it must clear
** this register on the next frame.  This register is only valid in EVRC.
*/
#define VC_EVRC_RESET_REG        VC_ENC_WEIGHTING_LSB
#define VC_EVRC_RESET_M          0x01
#define VC_EVRC_RESET_ON_V       0x01
#define VC_EVRC_RESET_OFF_V      0x00

#define VC_NOT_DEFINED           0x00
...
*/
#if !defined (T_MSM3)
#define VC_FM_RX_GAIN            VC_IO( 0x3C )
#endif /* !T_MSM3 */
...
#if !defined (T_MSM3)
#define VC_BG_NOISE_FLOOR_MSB    VC_IO( 0x3E )
#define VC_BG_NOISE_FLOOR_LSB    VC_IO( 0x40 )
#endif /* !T_MSM3 */
...
*/
#if !defined (T_MSM3)
#define VC_DTMF_DURATION_MSB     VC_IO( 0x42 )
#define VC_DTMF_DURATION_LSB     VC_IO( 0x44 )
#endif /* !T_MSM3 */
...
*/
#if !defined (T_MSM3)
#define VC_DTMF_HIGH_MSB         VC_IO( 0x46 )
#define VC_DTMF_HIGH_LSB         VC_IO( 0x48 )
#endif /* !T_MSM3 */

/* DTMF Low tone:  1 tone of DTMF, can be higher/lower than "high" tone.
** For format, see DTMF High Tone.
*/
#if !defined (T_MSM3)
#define VC_DTMF_LOW_MSB          VC_IO( 0x4A )
#define VC_DTMF_LOW_LSB          VC_IO( 0x4C )
#endif /* !T_MSM3 */

/* DTMF Volume:  The gain is a 15-bit unsigned linear value.
*/
#if !defined (T_MSM3)
#define VC_DTMF_VOL_MSB          VC_IO( 0x4E )
#define VC_DTMF_VOL_LSB          VC_IO( 0x50 )
#endif /* !T_MSM3 */
...
*/
#if !defined (T_MSM3)
#define VC_FM_DTMF_RX_GAIN       VC_IO( 0x4E )
#endif /* !T_MSM3 */
...
*/
#if !defined (T_MSM3)
#define VC_FM_DTMF_TX_GAIN       VC_IO( 0x50 )
#endif /* !T_MSM3 */
...
*/
#if !defined (T_MSM3)
#define VC_DEC_VOLUME_MSB        VC_IO( 0x52 )
#define VC_DEC_VOLUME_LSB        VC_IO( 0x54 )
#endif /* !T_MSM3 */
...
*/
#if !defined (T_MSM3)
#define VC_PCM_PAD_CONTROL       VC_IO( 0x56 )
#endif /* !T_MSM3 */

#define VC_PAD_ENC_PCM_COMPANDED_M       0x20    /* Enc Companded mode     */
#define VC_PAD_ENC_PCM_COMPANDED_ENA_V   0x20    /* Enable Companded mode  */
#define VC_PAD_ENC_PCM_COMPANDED_DIS_V   0x00    /* Disable Companded mode */
...
*/
#if !defined (T_MSM3)
#define VC_PCM_CONTROL_WORD_MSB  VC_IO( 0x58 )
#endif /* !T_MSM3 */
...
*/
#if !defined (T_MSM3)
#define VC_IO_CONTROL            VC_IO( 0x60 )
#endif /* !T_MSM3 */
...
*/
#if !defined (T_MSM3)
#define VC_CLEAR_ENC_INT         VC_IO( 0x62 )
#endif /* !T_MSM3 */
...
*/
#if !defined (T_MSM3)
#define VC_CLEAR_DEC_INT         VC_IO( 0x64 )
#endif /* !T_MSM3 */
...
*/
#if !defined (T_MSM3)
#define VC_DEC_PACKET            VC_IO( 0x66 )
#endif /* !T_MSM3 */
...
*/
#if !defined (T_MSM3)
#define VC_AUX_CODEC_CONTROL     VC_IO( 0x68 )
#endif /* !T_MSM3 */
...
// jwpark 00.10.12 : HFK
#ifdef MODEL_SKTT
#define VC_AUX_DEFAULT_V  ( VC_AUX_POL_NORMAL_V   | VC_AUX_CLK_VAL_HI_V \
                          | VC_AUX_SYNC_VAL_LO_V    | VC_AUX_CODEC_NORM_V \
                          | VC_AUX_CLK_DIS_V        | VC_SCS_LONG_AUX_SYNC_V \
                          | VC_AUX_DOUT_VAL_LO_V )
#else
...
*/
#if !defined (T_MSM3)
#define VC_GPIO_2930_CTL         VC_IO( 0x7C )
#endif /* !T_MSM3 */
...
*/
#if !defined (T_MSM3)
#define VC_ONES_POLARITY         VC_IO( 0x7E )
#endif /* !T_MSM3 */
...
---------------------------------------------------------------------------*/
/* Vocoder Encoder CODEC Read Data Register LSB
*/
#if !defined (T_MSM3)
#define VC_ENC_PCM_RD_LSB        VC_IO( 0x02 )
#endif /* !T_MSM3 */

/* Vocoder Status (non-FM status)
*/
#if !defined (T_MSM3)
#define VC_STATUS                VC_IO( 0x08 )
#endif /* !T_MSM3 */
...
/* Hardware/Software Version registers
*/
#if !defined (T_MSM3)
#define VC_HW_VERSION            VC_IO( 0x12 )
#define VC_SW_VERSION            VC_IO( 0x1e )
#endif /* !T_MSM3 */
...
*/
#if !defined (T_MSM3)
#define VC_FM_STATUS             VC_IO( 0x1C )
#endif /* !T_MSM3 */
...
*/
#if !defined (T_MSM3)
#define VC_ENC_PACKET            VC_IO( 0x20 )
#endif /* !T_MSM3 */
...
#if !defined (T_MSM3)
/* Max index for Vocoder section, this is used to size the shadow buffer
** The size is the maximum offset + 1 to account for the 0th entry.
*/
#define VC_MAX_INX               (0x7E + 1)

/* Array used as a shadow buffer for the write ports of the vocoder
** registers.  This allows individual bits to be written differently without
** being able to read back the current contents of the register.
*/
extern byte near vc_image[ VC_MAX_INX ];
#endif /* !T_MSM3 */
...
#else
#define VC_OUT( io, val )        (void) outp( io, (int) val )
#endif /* T_MSM3 */
/*---------------------------------------------------------------------------
                           MACRO VC_OUTM
...
#else
#define VC_OUTM( io, mask, val ) \
  INTLOCK(); \
  vc_image[ VC_INX( io ) ] = (vc_image[ VC_INX( io ) ] & (byte) (~(mask))) \
                             | (byte) ((val) & (mask)); \
  (void) outp( io, vc_image[ VC_INX( io )] ); \
  INTFREE()
#endif /* T_MSM3 */
...
#else
#define VC_INM( io, mask )       (inp( io ) & (mask))
#endif /* T_MSM3 */
