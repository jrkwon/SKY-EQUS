...
/*===========================================================================
  ...
  $Header:   L:/src/asw/COMMON/vcs/dsrlpseq.h_v   1.0   18 Oct 2000 18:07:00   jeffd  $
...
SIDE EFFECTS
  None
===========================================================================*/
/* RLP throughput 관련 수정사항 2001.10.15  by reo */
#define DSRLPSEQ_GEN_FROM_SEQ( seq_32, seq , L_VR, seq_mod)                 \
{                                                                           \
  uint32 VR = L_VR & 0x00FF0000;                                            \
  seq_32 = (((L_VR & 0x0FFF0000) +((int1)((0x0100 + seq - (VR >>16)) % 0x0100) << 16) ) % seq_mod); \
}

/*===========================================================================
...
===========================================================================*/
#define DSRLPSEQ_INCREMENT_SEQ(x)   \
        ((x + (uint32)0x10000) & 0x0FFFFFF0)

/*===========================================================================
...
===========================================================================*/
#define DSRLPSEQ_INCREMENT_S_SEQ(x)  \
        ((x + (uint32)0x10) & 0x0FFFFFF0)

/*===========================================================================
...
===========================================================================*/
#define DSRLPSEQ_INCREMENT_32BIT_SEQ(x) \
   (DSRLPSEQ_HAS_S_SEQ(x)?DSRLPSEQ_INCREMENT_S_SEQ(x):DSRLPSEQ_INCREMENT_SEQ(x))
...
===========================================================================*/
#define DSRLPSEQ_GET_NEXT_SEQ(x) \
     ((x + 0x00010000) & 0x0FFF0000)
