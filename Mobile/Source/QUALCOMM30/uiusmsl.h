...
$Header:   L:/src/asw/MSM5000/VCS/uiusmsl.h_v   1.2   18 May 2000 10:30:46   gshi  $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
05/10/00   HQ      Added check_msg_id field in the SMS list type.
...
extern byte ui_sms_text_list[MAX_NV_MSGS+1][UI_WIDE];
...
SIDE EFFECTS
  None
===========================================================================*/
extern word ui_sms_store_new_msg
(
  ui_cmd_type *cmd_ptr
);
