...
/*===========================================================================
  ...
  $Header:   L:/src/asw/COMMON/vcs/mdrrlp.h_v   1.0   23 Oct 2000 17:32:26   jeffd  $
...
02/10/99   smp     Added PACKED qualifier to union inside rlp_gen_pri_fr_type,
                   and to rlp_gen_frame_type union. This file is included if
		   FEATURE_SPECIAL_MDR is defined.
