...
#define COPYSTRINGN(dst, src, count) memcpy((void *)(dst), (const void *)(src), (count) * sizeof(WCHAR))
#define COMPARESTRINGN(a, b, s) memcmp((const void *)(a), (const void *)(b), (s) * sizeof(WCHAR))
#define CONCATSTRING(a, b)      w_strcat((WCHAR *)(a), (const WCHAR *)(b))
#define COPYSTRING(a, b)        w_strcpy((WCHAR *)(a), (const WCHAR *)(b))
#define COMPARESTRING(a, b)     w_strcmp((const WCHAR *)(a), (const WCHAR *)(b))
#define STRINGLENGTH(a)         w_strlen((const WCHAR *)(a))

/* BYTE macros */

#define B_COPYSTRINGN(dst, src, count) memcpy((void *)(dst), (const void *)(src), (count))
#define B_COPYSTRING(a, b)    strcpy((char *)(a), (const char *)(b))
#define B_COMPARESTRING(a, b) strcmp((const char *)(a), (const char *)(b))
#define B_STRINGLENGTH(a)     strlen((const char *)(a))
#define B_STRSTRING(a, b)     strstr((const char *)(a), (const char *)(b))
#define B_STRDUP(a)           n_strdup((const BYTE *)(a))
