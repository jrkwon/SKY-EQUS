...
static BYTE *ReverseLookup (const node_t *pn, INT8 idx)
{
  INT32 i;
						...
						pHEADBUILDSTR *ppList)
{
	...
	if (pbData!=NULL)
	{
		...
		if (pHead!=NULL)
		{
			...
			case Field_Accept_Charset_1_3:
			case Field_Accept_Language:
			case Field_Encoding_Version:
