...
==========================================================================
	...
	991101	JPR		Updated
    010315  ASPN    WTAI_SCRIPT_... defines added.
...
#define	WTAI_SCRIPT_FUNCTION_CALLED 1 /* WTAI function has been called and waiting for response. */
#define	WTAI_SCRIPT_RESULT	        2 /* Result has been pushed on the stack. */
#define WTAI_SCRIPT_ENDCONTEXT      3 /* The wtai script function EndContext has been called. */
