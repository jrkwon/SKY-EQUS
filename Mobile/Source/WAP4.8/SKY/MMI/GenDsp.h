...
#define WAP_SOFTKEY_Y_POS					126//WAP_LCD_HEIGHT - (WAP_SOFTKEY_HEIGHT + WAP_HEAD_HEIGHT)
...
//----------------------------------------------------------------
#define WAP_TITLE_BACK_COLOR    CAPTION_BACK_COLOR//BLUE//83
#define WAP_TITLE_TEXT_COLOR	CAPTION_FORE_COLOR
#define WAP_SELECT_BACK_COLOR   SELECT_BACK_COLOR//BLACK//1
#define WAP_SELECT_TEXT_COLOR   SELECT_FORE_COLOR//WHITE//255   
#define WAP_BASIC_BACK_COLOR    TEXT_BACK_COLOR//WHITE//255
#define WAP_BASIC_TEXT_COLOR    TEXT_FORE_COLOR//BLACK//0
...
#define WAP_LCD_HEIGHT					SKY_SCREEN_HEIGHT - WAP_HEAD_HEIGHT//SKY_ANNUNCIATORS_HEIGHT//146		//160-14	
...
enum{                       
    WAP_LEFT_CML_X     = 0, //39
    WAP_UPDOWN_CML_X   = 39,//10
    WAP_OK_CML_X       = 49,//12
    WAP_CENTER_CML_X   = 61,//28
    WAP_RIGHT_CML_X    = 89 //39
};
