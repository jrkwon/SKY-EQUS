...
/*========================================================================
	DTD_AddContentFunc
==========================================================================
	A function of this type is used for storing content in a element.
...
==========================================================================*/
typedef 
BOOL DTD_AddContentFunc (pDECSTR pDecStr, pELEMENTTYPE pElement, 
...
==========================================================================
	...
	Input: pWBXMLDECODESTR (not NULL), ** to Element and pointer to 
		   the parent element.
	Output: -
==========================================================================*/
typedef 
void DTD_AppSpecParseModFunc (pDECSTR pDecStr, pELEMENTTYPE *ppElement, 
...
typedef struct tWBXMLDECODESTR
{
	...
	DTD_AddContentFunc					*DTD_AddContent;
