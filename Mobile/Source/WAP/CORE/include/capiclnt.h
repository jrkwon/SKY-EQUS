...
#define BEARER_ANY_UDP  (BearerType) 0
#define BEARER_GSM_USSD (BearerType) 2
#define BEARER_GSM_SMS  (BearerType) 3
#define BEARER_GSM_CSD  (BearerType) 10
#define BEARER_GSM_GPRS (BearerType) 11
#define BEARER_BT       (BearerType) 150
#define BEARER_ANY      (BearerType) 255
...
{
    /* setStrConfig */
    configWSP_Language = configSTACKMODE + 1,
    configPROFILE,
    configPROFILE_DIFF,
    configUSERAGENT,
