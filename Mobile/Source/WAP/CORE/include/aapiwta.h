...
VOID    WTAIa_voiceCallSetup (UINT8 objectId, WCHAR *channelId, const CHAR *number);

VOID    WTAIa_voiceCallAccept (UINT8 objectId, WCHAR *channelId, INT8 callHandle);

VOID    WTAIa_voiceCallRelease (UINT8 objectId, WCHAR *channelId, INT8 callHandle);

VOID    WTAIa_voiceCallSendDTMF (UINT8 objectId, WCHAR *channelId, INT8 callHandle, const CHAR *dtmf);

VOID    WTAIa_voiceCallCallStatus (UINT8 objectId, WCHAR *channelId, INT8 callHandle, INT8 field);

VOID    WTAIa_voiceCallList (UINT8 objectId, WCHAR *channelId, BOOL returnFirst);



VOID    WTAIa_netTextSend (UINT8 objectId, WCHAR *channelId, const CHAR *number, const WCHAR *text);

VOID    WTAIa_netTextList (UINT8 objectId, WCHAR *channelId, BOOL returnFirst, INT8 messageType);

VOID    WTAIa_netTextRemove (UINT8 objectId, WCHAR *channelId, INT16 msgHandle);

VOID    WTAIa_netTextGetFieldValue (UINT8 objectId, WCHAR *channelId, INT16 msgHandle, INT8 field);

VOID    WTAIa_netTextMarkAsRead (UINT8 objectId, WCHAR *channelId, INT16 msgHandle);



VOID    WTAIa_phoneBookWrite (UINT8 objectId, WCHAR *channelId, INT16 index, const CHAR *number, const WCHAR *name);

VOID    WTAIa_phoneBookSearch (UINT8 objectId, WCHAR *channelId, INT8 field, const WCHAR *value);

VOID    WTAIa_phoneBookRemove (UINT8 objectId, WCHAR *channelId, INT16 index);

VOID    WTAIa_phoneBookGetFieldValue (UINT8 objectId, WCHAR *channelId, INT16 index, INT8 field);

VOID    WTAIa_phoneBookChange (UINT8 objectId, WCHAR *channelId, INT16 index, INT8 field, const WCHAR *newValue);



VOID    WTAIa_miscSetIndicator (UINT8 objectId, WCHAR *channelId, INT8 type, INT8 newState);



VOID    WTAIa_callLogDialled (UINT8 objectId, WCHAR *channelId, BOOL returnFirst);

VOID    WTAIa_callLogMissed (UINT8 objectId, WCHAR *channelId, BOOL returnFirst);

VOID    WTAIa_callLogReceived (UINT8 objectId, WCHAR *channelId, BOOL returnFirst);

VOID    WTAIa_callLogGetFieldValue (UINT8 objectId, WCHAR *channelId, INT16 logHandle, INT8 field);



VOID    WTAIa_GSMHold (UINT8 objectId, WCHAR *channelId, INT8 callHandle);

VOID    WTAIa_GSMRetrieve (UINT8 objectId, WCHAR *channelId, INT8 callHandle);

VOID    WTAIa_GSMTransfer (UINT8 objectId, WCHAR *channelId, INT8 callHandleB, INT8 callHandleC);

VOID    WTAIa_GSMDeflect (UINT8 objectId, WCHAR *channelId, INT8 callHandle, const CHAR *number);

VOID    WTAIa_GSMMultiparty (UINT8 objectId, WCHAR *channelId);

VOID    WTAIa_GSMSeparate (UINT8 objectId, WCHAR *channelId, INT8 callHandle);

VOID    WTAIa_GSMSendUSSD (UINT8 objectId, WCHAR *channelId, const WCHAR *message, const WCHAR *codingScheme, INT8 type, const CHAR *transactionId);

VOID    WTAIa_GSMNetinfo (UINT8 objectId, WCHAR *channelId, INT8 type);
