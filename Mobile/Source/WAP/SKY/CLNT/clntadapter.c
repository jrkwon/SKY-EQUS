        ...
        errornum <= ERR_HTTP_END)
    {
     ...
     errornum <= ERR_INTERNAL_END)
     {
         switch (errornum)
         {
            ...
            case ERR_WAE_WMLS_WTAI_FUNC_CALLED:
                cszErrorCode = "ERR_WAE_WMLS_WTAI_FUNC_CALLED";
                break;

            case ERR_WAE_WMLS_WTAI_RESULT:
                cszErrorCode = "ERR_WAE_WMLS_WTAI_RESULT";
                break;
